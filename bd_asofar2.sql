...
CREATE TABLE `co_detalle_orden_compra` (
  ...
  KEY `fk_cab_det_comp$1` (`id_orden_compra`),
  CONSTRAINT `fk_cab_det_comp$1` FOREIGN KEY (`id_orden_compra`) REFERENCES `co_orden_compras` (`id_orden_compra`)
...
CREATE TABLE `co_detalle_orden_pedido` (
  ...
  `total` decimal(10,7) DEFAULT NULL,
  PRIMARY KEY (`id_detalle_orden_compra`),
  KEY `fk_cab_det_ped$1` (`id_orden_pedido`),
  CONSTRAINT `fk_cab_det_ped$1` FOREIGN KEY (`id_orden_pedido`) REFERENCES `co_orden_pedido` (`id_orden_pedido`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `in_bodega` (
  ...
  CONSTRAINT `fk_empresa_sucursal$8` FOREIGN KEY (`id_empresa`, `id_sucursal`) REFERENCES `se_sucursal` (`id_empresa`, `id_sucursal`)
...
CREATE TABLE `in_detalle_movimiento` (
  ...
  KEY `id_movimientos` (`id_movimientos`),
  CONSTRAINT `in_detalle_movimiento_ibfk_1` FOREIGN KEY (`id_movimientos`) REFERENCES `in_movimientos` (`id_movimientos`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `in_kardex` (
  ...
  KEY `fk_bodega$3` (`id_bodega`),
  KEY `fk_prestaciones$3` (`id_prestaciones`),
  KEY `fk_tipo_movimiento$2` (`id_tipo_movimiento`),
  KEY `fk_tipo_documentos$2` (`id_tipo_documento`),
  CONSTRAINT `fk_bodega$3` FOREIGN KEY (`id_bodega`) REFERENCES `in_bodega` (`id_bodega`),
  CONSTRAINT `fk_empresa_sucursal$9` FOREIGN KEY (`id_empresa`, `id_sucursal`) REFERENCES `se_sucursal` (`id_empresa`, `id_sucursal`),
  CONSTRAINT `fk_prestaciones$3` FOREIGN KEY (`id_prestaciones`) REFERENCES `pr_prestaciones` (`id_prestacion`),
...
CREATE TABLE `in_movimientos` (
  ...
  `id_orden_compra` bigint(11) NOT NULL,
  `id_usuario_creacion` bigint(11) DEFAULT NULL,
  `fecha_creacion` datetime DEFAULT NULL,
  `id_usuario_actualizacion` bigint(11) DEFAULT NULL,
  `fecha_actualizacion` datetime DEFAULT NULL,
  PRIMARY KEY (`id_movimientos`,`id_tipo_documento`,`id_empresa`,`id_sucursal`,`id_bodega`,`id_usuario`,`id_proveedor`,`id_orden_compra`),
  KEY `fk_tipo_documento$5` (`id_numero_documento`),
  KEY `fk_bodega_empresa_sucursal$3` (`id_empresa`,`id_sucursal`,`id_bodega`),
  KEY `fk_usuario$6` (`id_usuario`),
  KEY `fk_provedor$1` (`id_proveedor`),
  KEY `fk_compra$2` (`id_orden_compra`),
  CONSTRAINT `fk_bodega_empresa_sucursal$3` FOREIGN KEY (`id_empresa`, `id_sucursal`, `id_bodega`) REFERENCES `in_bodega` (`id_empresa`, `id_sucursal`, `id_bodega`),
  CONSTRAINT `fk_compra$2` FOREIGN KEY (`id_orden_compra`) REFERENCES `co_orden_compras` (`id_orden_compra`),
  CONSTRAINT `fk_provedor$1` FOREIGN KEY (`id_proveedor`) REFERENCES `se_personas` (`id_persona`),
  CONSTRAINT `fk_tipo_documento$5` FOREIGN KEY (`id_numero_documento`) REFERENCES `in_tipo_documento` (`id_tipo_documento`),
  CONSTRAINT `fk_usuario$6` FOREIGN KEY (`id_usuario`) REFERENCES `se_usuarios` (`id_usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `in_tipo_bodega` (
  `id_tipo_bodega` bigint(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `pr_detalle_tarifario` (
  ...
  KEY `fk_prestacion$1` (`id_prestacion`),
  KEY `fk_tarifario_empresa_sucursal$1` (`id_tarifario`,`id_empresa`,`id_surcusal`),
  KEY `fk_unidad_servicio$2` (`id_unidad_servicio`),
  CONSTRAINT `fk_prestacion$1` FOREIGN KEY (`id_prestacion`) REFERENCES `pr_prestaciones` (`id_prestacion`),
...
INSERT INTO `pr_grupos` VALUES (1,1,'MEDICINA','A',1,'2019-04-18 15:42:36',NULL,NULL);
...
CREATE TABLE `pr_prestaciones` (
  ...
  KEY `fk_producto$3` (`id_poducto`),
  CONSTRAINT `fk_empresa$3` FOREIGN KEY (`id_empresa`) REFERENCES `se_empresa` (`id_empresa`),
  CONSTRAINT `fk_producto$3` FOREIGN KEY (`id_poducto`) REFERENCES `pr_productos` (`id_producto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pr_producto_bodega` (
  ...
  PRIMARY KEY (`id_producto_bodega`,`id_bodega`,`id_producto`,`id_empresa`,`id_sucursal`),
  KEY `fk_bod_ProBod$1` (`id_bodega`),
  KEY `fk_prod_prodBod$2` (`id_producto`),
  KEY `fk_empresa_sucursal$7` (`id_empresa`,`id_sucursal`),
  CONSTRAINT `fk_bodega$1` FOREIGN KEY (`id_bodega`) REFERENCES `in_bodega` (`id_bodega`),
  CONSTRAINT `fk_empresa_sucursal$7` FOREIGN KEY (`id_empresa`, `id_sucursal`) REFERENCES `se_sucursal` (`id_empresa`, `id_sucursal`),
  CONSTRAINT `fk_prod_prodBod$2` FOREIGN KEY (`id_producto`) REFERENCES `pr_productos` (`id_producto`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pr_productos` (
  ...
  KEY `fk_medida_product$1` (`id_articulo`,`id_grupo`,`id_subgrupo`,`id_tipo_presentacion`),
  KEY `fk_tipo_presentacion$2` (`id_tipo_presentacion`),
  KEY `fk_empresa$6` (`id_empresa`),
  KEY `fk_tipo_medidas$3_idx` (`id_tipo_medidas`),
  CONSTRAINT `fk_empresa$6` FOREIGN KEY (`id_empresa`) REFERENCES `se_empresa` (`id_empresa`),
  CONSTRAINT `fk_medida_product$1` FOREIGN KEY (`id_articulo`, `id_grupo`, `id_subgrupo`, `id_tipo_presentacion`) REFERENCES `pr_medidas` (`id_articulo`, `id_grupo`, `id_subgrupo`, `id_tipo_presentacion`),
  CONSTRAINT `fk_tipo_medidas$3` FOREIGN KEY (`id_tipo_medidas`) REFERENCES `pr_tipo_medidas` (`id_tipo_medidas`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `ve_factura` (
  ...
  `usuario_actualizacion` bigint(20) DEFAULT NULL,
  `fecha_actualizacion` datetime DEFAULT NULL,
  PRIMARY KEY (`id_factura`,`id_caja`,`id_empresa`,`id_sucursal`,`id_usuario`,`id_cliente`),
...
CREATE TABLE `ve_factura_detalle` (
  ...
  KEY `fk_factura$1` (`id_factura`),
  KEY `fk_unidad_servicio$1` (`id_unidad_servicio`),
  KEY `fk_empresa_sucursal$3` (`id_empresa`,`id_sucursal`),
  KEY `fk_prestaciones$1` (`id_prestaciones`),
  CONSTRAINT `fk_empresa_sucursal$3` FOREIGN KEY (`id_empresa`, `id_sucursal`) REFERENCES `se_sucursal` (`id_empresa`, `id_sucursal`),
  CONSTRAINT `fk_factura$1` FOREIGN KEY (`id_factura`) REFERENCES `ve_factura` (`id_factura`),
  CONSTRAINT `fk_prestaciones$1` FOREIGN KEY (`id_prestaciones`) REFERENCES `pr_prestaciones` (`id_prestacion`),
...
-- Dump completed on 2019-04-22 19:50:25
