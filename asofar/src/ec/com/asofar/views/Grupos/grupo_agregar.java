 ...
 * @author admin1
 */
public class grupo_agregar extends javax.swing.JDialog {
     ...
     */
    public grupo_agregar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                grupo_agregar dialog = new grupo_agregar(new javax.swing.JFrame(), true);
