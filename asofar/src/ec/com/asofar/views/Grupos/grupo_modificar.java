 ...
 * @author admin1
 */
public class grupo_modificar extends javax.swing.JDialog {
     ...
     */
    public grupo_modificar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public grupo_modificar(java.awt.Frame parent, boolean modal, PrGrupos obj) {
        super(parent, modal);
        initComponents();
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        ...
        setVisible(false);
        ConsultaGrupos cg = new ConsultaGrupos(new javax.swing.JFrame(), true);
        cg.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(grupo_modificar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                grupo_modificar dialog = new grupo_modificar(new javax.swing.JFrame(), true);
