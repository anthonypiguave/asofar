 ...
 * @author admin1
 */
public class ConsultaCajaInactivasForm extends javax.swing.JDialog {
    ...
    public ConsultaCajaInactivasForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        cargarInformacion();
    ...
    private void cargarInformacion() {
        try {
            ...
            Tablas.listarCajasInactivas(lista, tbCaja);
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaCajaInactivasForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultaCajaInactivasForm dialog = new ConsultaCajaInactivasForm(new javax.swing.JFrame(), true);
