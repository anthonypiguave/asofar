 ...
 * @author admin1
 */
public class CrearCajaForm extends javax.swing.JDialog {
     ...
     */
    public CrearCajaForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CrearCajaForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CrearCajaForm dialog = new CrearCajaForm(new javax.swing.JFrame(), true);
