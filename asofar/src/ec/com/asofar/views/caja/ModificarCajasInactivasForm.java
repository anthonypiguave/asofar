 ...
 * @author admin1
 */
public class ModificarCajasInactivasForm extends javax.swing.JDialog {
     ...
     */
    public ModificarCajasInactivasForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public ModificarCajasInactivasForm(java.awt.Frame parent, boolean modal, VeCaja obj) {
        super(parent, modal);
        initComponents();
    ...
    private void btnGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGrabarActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Caja Activada");
            setVisible(false);
            ConsultaCajaInactivasForm cs = new ConsultaCajaInactivasForm(new javax.swing.JFrame(), true);
            cs.setVisible(true);
        }  catch (Exception ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarCajasInactivasForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModificarCajasInactivasForm dialog = new ModificarCajasInactivasForm(new javax.swing.JFrame(), true);
