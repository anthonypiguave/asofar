 ...
 * @author alumno
 */
public class ActualizarDatosEmpresa extends javax.swing.JDialog {
...
//    private String rutaimagen = "";
    ...
    public ActualizarDatosEmpresa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
    }

    public ActualizarDatosEmpresa(java.awt.Frame parent, boolean modal, SeEmpresa empresa, SeUsuarios us, SeEmpresa em, SeSucursal su) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        empresa = empresa;
    ...
    public void bloqueo() {
        ...
        if (r == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                Logger.getLogger(ActualizarDatosEmpresa.class.getName()).log(Level.SEVERE, null, ex);
            }
...
//    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ActualizarDatosEmpresa dialog = new ActualizarDatosEmpresa(new javax.swing.JFrame(), true);
