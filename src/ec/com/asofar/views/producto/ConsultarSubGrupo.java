 ...
 * @author admin1
 */
public class ConsultarSubGrupo extends javax.swing.JDialog {
     ...
     */
    public ConsultarSubGrupo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public ConsultarSubGrupo(java.awt.Frame parent, boolean modal, PrGrupos objeto) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        gruposObjeto = objeto;
    ...
    public PrSubgrupos devuelveObjeto(String datos, List<PrSubgrupos> listaobjeto) {

        PrSubgrupos objeto1 = null;

        for (int i = 0; i < listaobjeto.size(); i++) {

            if (datos.equals("" + listaobjeto.get(i).getPrSubgruposPK().getIdSubgrupo())) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarSubGrupo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultarSubGrupo dialog = new ConsultarSubGrupo(new javax.swing.JFrame(), true);
