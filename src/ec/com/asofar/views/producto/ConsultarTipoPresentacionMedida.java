...
public class ConsultarTipoPresentacionMedida extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PRESENTACION Y MEDIDAS");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(txtfiltro, javax.swing.GroupLayout.PREFERRED_SIZE, 334, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(61, 61, 61))
        );
    ...
    public void cargartabla() {
        ...
        for (int i = 0; i < articulo.getPrMedidasList().size(); i++) {
            ...
            lista.add(articulo.getPrMedidasList().get(i));

        }

        Tablas.ListarTipoPresentacionMedidaConsulta(lista, tabla);
    }
    ...
    private void tablaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            objeto = devuelveObjeto(tabla.getValueAt(i, 0).toString(), tabla.getValueAt(i, 1).toString(), lista);
    ...
    public PrMedidas getObjeto() {
        return objeto;
    }

    public PrMedidas devuelveObjeto(String datos1, String datos2, List<PrMedidas> listaobjeto) {

        PrMedidas objeto1 = null;

        for (int i = 0; i < listaobjeto.size(); i++) {

            if (datos1.equals(listaobjeto.get(i).getPrTipoPresentacion().getNombre())
                    && datos2.equals(listaobjeto.get(i).getPrTipoMedidas().getNombreTipoMedida())) {
