 ...
 * @author admin1
 */
public class ConsultarTipoPresentacion extends javax.swing.JDialog {
    ...
    PrTipoPresentacion objeto = new PrTipoPresentacion();

    /**
     * Creates new form ConsultaProducto
     */
    public ConsultarTipoPresentacion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public ConsultarTipoPresentacion(java.awt.Frame parent, boolean modal, SeUsuarios us, SeEmpresa em, SeSucursal su) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        seUsuario = us;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TIPO PRESENTACION");
    ...
    public void cargartabla() {
        ...
        Tablas.ListarTipoPresentacionConsulta(lista, tabla);
    }
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        NuevoTipoPresentacion dialog = new NuevoTipoPresentacion(new javax.swing.JFrame(), true, seUsuario, seEmpresa, seSucursal);
        dialog.setVisible(true);
        cargartabla();
    }//GEN-LAST:event_btnNuevoActionPerformed

    public PrTipoPresentacion getObjeto() {
        return objeto;
    }

    public PrTipoPresentacion devuelveObjeto(String datos, List<PrTipoPresentacion> listaobjeto) {

        PrTipoPresentacion objeto1 = null;

        for (int i = 0; i < listaobjeto.size(); i++) {

            if (datos.equals("" + listaobjeto.get(i).getIdTipoPresentacion())) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarTipoPresentacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
