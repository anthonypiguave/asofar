 ...
 * @author admin1
 */
public class ConsultarGrupo extends javax.swing.JDialog {
    ...
    PrGrupos objeto = new PrGrupos();

    /**
     * Creates new form ConsultaProducto
     */
    public ConsultarGrupo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(txtfiltro, javax.swing.GroupLayout.PREFERRED_SIZE, 337, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public PrGrupos devuelveObjeto(String datos, List<PrGrupos> listaobjeto) {

        PrGrupos objeto1 = null;

        for (int i = 0; i < listaobjeto.size(); i++) {

            if (datos.equals("" + listaobjeto.get(i).getIdGrupo())) {
