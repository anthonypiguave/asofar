 ...
 * @author admin1
 */
public class NuevoTipoPresentacion extends javax.swing.JDialog {
    ...
    List<PrTipoPresentacion> lista;
    PrTipoPresentacionJpaController cont = new PrTipoPresentacionJpaController(EntityManagerUtil.ObtenerEntityManager());

    /**
     * Creates new form ConsultaProducto
     */
    public NuevoTipoPresentacion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public NuevoTipoPresentacion(java.awt.Frame parent, boolean modal, SeUsuarios us, SeEmpresa em, SeSucursal su) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        seUsuario = us;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("AGREGAR PRESENTACION");
        ...
        txtTipoPresentacion.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtTipoPresentacionFocusLost(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(txtTipoPresentacion, javax.swing.GroupLayout.PREFERRED_SIZE, 256, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        PrTipoPresentacion obj = new PrTipoPresentacion();
    ...
    private void txtTipoPresentacionFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtTipoPresentacionFocusLost
       txtTipoPresentacion.setText(txtTipoPresentacion.getText().toUpperCase());
    }//GEN-LAST:event_txtTipoPresentacionFocusLost
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NuevoTipoPresentacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NuevoTipoPresentacion dialog = new NuevoTipoPresentacion(new javax.swing.JFrame(), true);
