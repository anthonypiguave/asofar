 ...
 * @author admin1
 */
public class ConsultarTipoMedida extends javax.swing.JDialog {
     ...
     */
    public ConsultarTipoMedida(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public PrTipoMedidas devuelveObjeto(String datos, List<PrTipoMedidas> listaobjeto) {

        PrTipoMedidas objeto1 = null;

        for (int i = 0; i < listaobjeto.size(); i++) {

            if (datos.equals("" + listaobjeto.get(i).getIdTipoMedidas())) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarTipoMedida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
