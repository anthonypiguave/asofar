 ...
 * @author admin1
 */
public class ConsultarBodega extends javax.swing.JDialog {
    ...
    List<InBodega> lista;
    InBodegaJpaController cont = new InBodegaJpaController(EntityManagerUtil.ObtenerEntityManager());
    InBodega objeto = new InBodega();

    /**
     * Creates new form ConsultaProducto
     */
    public ConsultarBodega(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    public ConsultarBodega(java.awt.Frame parent, boolean modal, SeUsuarios us, SeEmpresa em, SeSucursal su) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        setLocationRelativeTo(null);
    ...
    public void cargartabla() {
        ...
        lista = new ArrayList<InBodega>();
        lista = cont.findInBodegaEntities();
        Tablas.ListarBodegaConsulta(lista, tabla);
    }
    ...
    public InBodega getObjeto() {
        return objeto;
    }

    public InBodega devuelveObjeto(String datos, List<InBodega> listaobjeto) {

        InBodega objeto1 = null;

        for (int i = 0; i < listaobjeto.size(); i++) {

            if (datos.equals("" + listaobjeto.get(i).getInBodegaPK().getIdBodega())) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultarBodega dialog = new ConsultarBodega(new javax.swing.JFrame(), true);
