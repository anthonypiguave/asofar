 ...
 * @author admin1
 */
public class ConsultarTipoIdentificacion extends javax.swing.JDialog {
    ...
    List<SeTipoIdentificacion> lista;
    SeTipoIdentificacionJpaController cont = new SeTipoIdentificacionJpaController(EntityManagerUtil.ObtenerEntityManager());
    SeTipoIdentificacion objeto = new SeTipoIdentificacion();

    /**
     * Creates new form ConsultaProducto
     */
    public ConsultarTipoIdentificacion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void cargartabla() {
        ...
        lista = new ArrayList<SeTipoIdentificacion>();
        lista = cont.findSeTipoIdentificacionEntities();
        Tablas.ListarTipoIdentificacionConsulta(lista, tabla);
    }
    ...
    public SeTipoIdentificacion getObjeto() {
        return objeto;
    }

    public SeTipoIdentificacion devuelveObjeto(String datos, List<SeTipoIdentificacion> listaobjeto) {

        SeTipoIdentificacion objeto1 = null;

        for (int i = 0; i < listaobjeto.size(); i++) {

            if (datos.equals("" + listaobjeto.get(i).getIdTipoIdentificacion())) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarTipoIdentificacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
