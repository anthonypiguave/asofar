 ...
 * @author admin1
 */
public class ConsultarCiudad extends javax.swing.JDialog {
    ...
    List<SeCiudad> lista;
    List<SeCiudad> list;
    SeCiudadJpaController cont = new SeCiudadJpaController(EntityManagerUtil.ObtenerEntityManager());
    SeCiudad objeto = new SeCiudad();
    SeProvincia provincia = new SeProvincia();

    /**
     * Creates new form ConsultaProducto
     */
    public ConsultarCiudad(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public ConsultarCiudad(java.awt.Frame parent, boolean modal, SeProvincia obj, SeUsuarios us, SeEmpresa em, SeSucursal su) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        provincia = obj;
...
//                System.out.println("lista"+list.get(i).getNombre());
        ...
        Tablas.ListarCiudadConsulta(list, tabla);
    }
    ...
    public SeCiudad getObjeto() {
        return objeto;
    }

    public SeCiudad devuelveObjeto(String datos, List<SeCiudad> listaobjeto) {

        SeCiudad objeto1 = null;

        for (int i = 0; i < listaobjeto.size(); i++) {

            if (datos.equals("" + listaobjeto.get(i).getIdCiudad())) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultarCiudad dialog = new ConsultarCiudad(new javax.swing.JFrame(), true);
