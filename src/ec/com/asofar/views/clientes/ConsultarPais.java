 ...
 * @author admin1
 */
public class ConsultarPais extends javax.swing.JDialog {
    ...
    List<SePais> lista;
    SePaisJpaController cont = new SePaisJpaController(EntityManagerUtil.ObtenerEntityManager());
    SePais objeto = new SePais();

    /**
     * Creates new form ConsultaProducto
     */
    public ConsultarPais(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public ConsultarPais(java.awt.Frame parent, boolean modal, SeUsuarios us, SeEmpresa em, SeSucursal su) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        cargartabla();
    ...
    public void cargartabla() {
        ...
        lista = new ArrayList<SePais>();
        lista = cont.findSePaisEntities();
        Tablas.ListarPaisConsulta(lista, tabla);
    }
    ...
    public SePais getObjeto() {
        return objeto;
    }

    public SePais devuelveObjeto(String datos, List<SePais> listaobjeto) {

        SePais objeto1 = null;

        for (int i = 0; i < listaobjeto.size(); i++) {

            if (datos.equals("" + listaobjeto.get(i).getIdPais())) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultarPais dialog = new ConsultarPais(new javax.swing.JFrame(), true);
