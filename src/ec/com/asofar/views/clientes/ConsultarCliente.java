...
public class ConsultarCliente extends javax.swing.JDialog {
    ...
    public ConsultarCliente(java.awt.Frame parent, boolean modal, SeUsuarios us, SeEmpresa em, SeSucursal su) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        seUsuario = us;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultarCliente dialog = new ConsultarCliente(new javax.swing.JFrame(), true);
