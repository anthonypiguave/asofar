 ...
 * @author admin1
 */
public class AgregarGruposForm extends javax.swing.JDialog {
     ...
     */
    public AgregarGruposForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(btnCancelar, javax.swing.GroupLayout.PREFERRED_SIZE, 27, Short.MAX_VALUE)
                        .addGap(4, 4, 4)))
...
//                pr.setUsuarioActualizacion(BigInteger.valueOf(1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarGruposForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AgregarGruposForm dialog = new AgregarGruposForm(new javax.swing.JFrame(), true);
