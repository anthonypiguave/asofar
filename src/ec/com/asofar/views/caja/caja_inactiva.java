 ...
 * @author admin1
 */
public class caja_inactiva extends javax.swing.JDialog {
    ...
    public caja_inactiva(java.awt.Frame parent, boolean modal) {
    ...
    public caja_inactiva(java.awt.Frame parent, boolean modal, SeUsuarios us, SeEmpresa em, SeSucursal su) {
        super(parent, modal=false);
        initComponents();
        cargarInformacion();
        setLocationRelativeTo(null);
    ...
    private void cargarInformacion() {
        try {
            ...
            Tablas.TablaCajaInactiva(lista, tbCajas);
        } catch (Exception e) {
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CAJAS INACTIVAS");
        ...
        btnsalir.setBackground(new java.awt.Color(255, 246, 246));
    ...
    private void btnsalirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsalirActionPerformed
        setVisible(false);
        caja caja = new caja(new javax.swing.JFrame(), true, seUsuario, seEmpresa, seSucursal);
    ...
    private void btnimprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnimprimirActionPerformed
        ...
        try {
            JasperReport reporte = (JasperReport)JRLoader.loadObject(System.getProperty("user.dir")+"/Reportes/caja_inactiva.jasper");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(caja_inactiva.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                caja_inactiva dialog = new caja_inactiva(new javax.swing.JFrame(), true);
