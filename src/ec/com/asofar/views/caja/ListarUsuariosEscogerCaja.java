...
public class ListarUsuariosEscogerCaja extends javax.swing.JDialog {
    ...
    public ListarUsuariosEscogerCaja(java.awt.Frame parent, boolean modal, SeUsuarios us, SeEmpresa em, SeSucursal su) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        us1 = us;
    ...
    public SeUsuarios devuelveObjeto(Long id, List<SeUsuarios> lista) {
        SeUsuarios doc = null;
        for (int i = 0; i < lista.size(); i++) {
            if (Objects.equals(lista.get(i).getIdUsuario(), id)) {
                doc = lista.get(i);
                break;
            }
        }
    ...
    private void jtPersonasMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtPersonasMousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            obj = devuelveObjeto(Long.valueOf(jtPersonas.getValueAt(id, 0).toString()), usuario_lista);
            if (obj != null) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListarUsuariosEscogerCaja dialog = new ListarUsuariosEscogerCaja(new javax.swing.JFrame(), true);
