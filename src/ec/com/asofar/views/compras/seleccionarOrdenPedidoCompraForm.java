...
public class seleccionarOrdenPedidoCompraForm extends javax.swing.JDialog {
    ...
    public seleccionarOrdenPedidoCompraForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public seleccionarOrdenPedidoCompraForm(java.awt.Frame parent, boolean modal, SeUsuarios us, SeEmpresa em, SeSucursal su) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
...
//                this.setVisible(false);
    ...
    private void cargarMostrarTabla() {
        try {
            ...
            Tablas.listarCabOrdendePedidoCompra(lista, tbAprobar);
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionarOrdenPedidoCompraForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                seleccionarOrdenPedidoCompraForm dialog = new seleccionarOrdenPedidoCompraForm(new javax.swing.JFrame(), true);
